...
**Plans**: 10 plans（Wave 0 拆 docs/stubs + 四 CONTEXT wave 拆解 + Wave1c gate）

Plans:

- [ ] 03-00-PLAN.md — Wave 0a：D-04/D-06 双写文档 + GOLDEN-01/CP-01/CORPUS-01
- [ ] 03-00b-PLAN.md — Wave 0b：Nyquist 回归/单测骨架 + migrate dry-run + scripts
...
- [ ] 03-04-PLAN.md — Wave2a：Redis 短期 + Mem0 长期记忆注入
...
| 3. 记忆 + 高级 RAG | v2.0 / v3.0 | 0/10 | Planned | — |
